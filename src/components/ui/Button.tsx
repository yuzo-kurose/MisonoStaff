...
const base =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-lg text-label-md font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-50";
